...
program
  .command('upgrade-rn')
  .description('Dangerous. Updates the React Native version of the mobile folder of the current project to 0.59.2. Run ONLY on a git repository with no pending commits.')
