...
async function doUpgrade() {
  ...
  await promisedExec('pushd mobile && yarn remove babel-eslint babel-preset-env babel-preset-react rnpm && yarn add --dev babel-jest@23.6.0 jest@23.6.0 metro-react-native-babel-preset@0.49.2 react-test-renderer@16.6.1 ; popd')
